...
class InitialSeeder {
    ...
    async run() {
        try {
            ...
            const stationRepository = this.dataSource.getRepository(station_entity_1.Station);
            const stations = [
                {
                    name: 'Kitchen',
                    activities: [
            ...
            const activityRepository = this.dataSource.getRepository(activity_entity_1.Activity);
